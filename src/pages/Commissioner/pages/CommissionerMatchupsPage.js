/* -----------------------------------------------------------------------
   src/pages/Commissioner/pages/CommissionerMatchupsPage.js
   ----------------------------------------------------------------------- */
   ...
   export default function CommissionerMatchupsPage() {
     /* ───────────────────────── hooks / helpers ────────────────────────── */
         ...
         try {
           ...
           if (!snap.exists()) {
             ...
             if (!loggedViewRef.current && analytics) {
               logEvent(analytics, "commissioner_matchups_page_viewed", {
           ...
           console.error("CommissionerMatchupsPage – fetch error:", err);
     ...
     if (loading) {
       return (
         <Container maxWidth="md" sx={{ py: 4, textAlign: "center" }}>
           <CircularProgress aria-label="Loading matchups data" />

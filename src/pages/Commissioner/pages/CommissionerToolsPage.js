/* -----------------------------------------------------------------------
   src/pages/Commissioner/pages/CommissionerToolsPage.js
   ----------------------------------------------------------------------- */
         ...
         try {
           ...
           if (!snap.exists()) {
             ...
             if (!loggedViewRef.current && analytics) {
               logEvent(analytics, "commissioner_tools_page_viewed", {
           ...
           console.error("CommissionerToolsPage – fetch error:", err);
     ...
     if (loading) {
       return (
         <Container maxWidth="md" sx={{ py: 4, textAlign: "center" }}>
           <CircularProgress aria-label="Loading tools data" />
